...
function preload() {
    ...
    this.load.image('faccia', 'assets/entities/faccia.png'); // Carica l'immagine della faccia
...
function createControls() {
    ...
    // Aggiungi tasti per testare i poteri di Mario
    controlKeys.GROW = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.G); // G per Grow
    controlKeys.FIRE_POWER = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.F); // F per Fire
